    ...
    <div class="container" style="display: flex;align-items: center;">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li <?php if(request()->routeIs('document')): ?> class="active" <?php endif; ?>><a class="nav-link" href="<?php echo e(route('document')); ?>"><?php echo e(__('Document')); ?></a></li>
            </ul>
...
<?php /**PATH C:\OSPanel\domains\ga\resources\views/layouts/navbarGuest.blade.php ENDPATH**/ ?>